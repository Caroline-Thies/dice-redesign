...
export default function getBestProbability( maxDice, minValue, maxValue, mastered) {
    // check if dice > 0
    if (maxDice < 1) {
    ...
    for (let i = 0; i < maxDice; i++){
        ...
        probs.push(getResultInRangeProb(toRoll, minValue-invested, maxValue+invested))
    }
