...
export default function ConcentrationView(props) {
    ...
    const concentrate = () => {
        ...
        for (let i = startLevel + 1; i <= goalLevel; i++) {
            const rollResult = rollD6(props.wisdom + props.selfControl, false)
    ...
    return <div className="flexcol">
        ...
        <h4>Startstufe</h4>
        <NumberPicker name="startLevel" max={props.wisdom - 1} selected={startLevel} onChange={setStartLevel} startsWithZero={true} />
        <h4>Zielstufe</h4>
