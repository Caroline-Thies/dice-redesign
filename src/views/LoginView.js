    ...
    <div className="login_page">
      <div className="login_content">
        ...
        <p>
          ...
          umher schiebst und eventuell sogar einen Taschenrechner herausholst,
          bevor du endlich deinen Zug im Kampf machst?
        </p>
        <p>
          Dann solltest du den inoffiziellen NoReturn PsiCalculator verwenden!
        </p>
        <p>
      ...
      <div className="login_form">
        <h2>Login will happen here</h2>
        <p>enter username here</p>
        <p>and maybe a password</p>
