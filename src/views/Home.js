...
export default function Home(props) {
      ...
      return (
        <div>
          ...
          <div className="recentlyUsedContainer">
            {props.recentlyUsed.map((app, index) => (
              <ImageTextCard text={app} key={index} />
            ))}
          </div>
        </div>
      );
  ...
  return (
    <div className="flexcol">
      ...
      <div>
        <h4>Kürzlich eingesetzt</h4>
        <div className="recentlyUsedContainer">{recentlyUsedApps()}</div>
      </div>
      <div>
        ...
        <div className="furtherActionsContainer">
          ...
          <ImageTextCard
            text="Konzentrieren"
            imgSource={meditation}
            onClick={() =>
              navigate("Concentrate", { state: { wisdom: character.wisdom } })
            }
          />
          <ImageTextCard
            text="Apps anpassen"
